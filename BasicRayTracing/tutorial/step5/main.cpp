...
int main()
{
    ...
    Material yuhong( Vec2f( 0.6, 0.3 ), Vec3f( 0.75, 0.28, 0.32 ), 50. );
    Material xinlan( Vec2f( 0.5, 0.4 ), Vec3f( 0.58, 0.71, 0.81 ), 10. );
    Material cuilv( Vec2f( 0.5, 0.1 ), Vec3f( 0.13, 0.49, 0.38 ), 20. );
    Material rubai( Vec2f( 0.3, 0.1 ), Vec3f( 0.98, 0.96, 0.86 ), 30. );
